...
def doints_Pgg():
	...
	np.savetxt('./txtfiles/Pgg/Pggterm_gamtBl_extl_'+endfilename+'_sample='+SAMPLE+'_deltaz='+str(pa.delta_z)+'_'+endfile+'.txt', int_gg)
...
def doints_Pgk():
	...
	np.savetxt('./txtfiles/Pgk/Pgkterm_gamtBl_extl_'+endfilename+'_sample='+SAMPLE+'_deltaz='+str(pa.delta_z)+'_'+endfile+'.txt', int_gk**2 )
...
def doints_Pkk():
	...
	np.savetxt('./txtfiles/Pkk/Pkkterm_gamtBl_extl_'+endfilename+'_sample='+SAMPLE+'_deltaz='+str(pa.delta_z)+'_'+endfile+'.txt', int_kk)
...
def doints_PggPkk():
	...
	np.savetxt(folderpath+outputfolder+'/PggPkk/PggPkkterm_gamtBl_extl_'+endfilename+'_sample='+SAMPLE+'_deltaz='+str(pa.delta_z)+'_'+endfile+'.txt', int_kkgg)
...
def doconstint():
	...
	np.savetxt('./txtfiles/const/const_gamtBl_extl_'+endfilename+'_sample='+SAMPLE+'_deltaz='+str(pa.delta_z)+'_'+endfile+'.txt', save)
...
print "Done with PggPkk integrals."
